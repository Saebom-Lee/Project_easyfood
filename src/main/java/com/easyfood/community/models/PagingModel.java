package com.easyfood.community.models;
...
public class PagingModel {
    ...
    public PagingModel(int paginationCount, int rowCountPerPage, int totalRowCount, int requestPage) {
        ...
        this.maxPage = Math.max(1, this.totalRowCount / this.rowCountPerPage +
                (this.totalRowCount % this.rowCountPerPage == 0 ? 0 : 1));
        ...
        this.boundEndPage = Math.min(this.maxPage, (this.requestPage / this.paginationCount)
